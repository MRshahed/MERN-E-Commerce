...
const Product = () => {
  ...
  return (
    <div>
      <Navbar />
      <Announcement />
      <div className="container mx-auto lg:py-8 lg:px-16 md:py-12 md:px-0 py-9 px-4 ">
        <div className="flex justify-center items-center lg:flex-row-reverse flex-col-reverse gap-10">
          {/* <!-- Description Div --> */}
          ...
          <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
            ...
            <div className="lg:mt-11 mt-10">
              ...
              <div className=" flex flex-row justify-between items-center mt-4">
                ...
                <div className=" grid grid-cols-3 gap-10 sm:flex sm:flex-wrap md:gap-4 sm:justify-between lg:justify-start mt-0">
                  <div
                    onClick={() => getSize("XSS")}
                    id="XSS"
                    className={
          ...
          <div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-4 sm:gap-6 gap-4">
